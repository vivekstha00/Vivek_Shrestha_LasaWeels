...
<div class="d-flex justify-content-between align-items-center mb-5">
    <div>
        ...
        <p class="text-muted">Manage vendor subscription plans</p>
    </div>
    ...
    <div class="card-body p-0">
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        @foreach($plans as $plan)
                            <tr onclick="window.location='{{ route('admin.subscription-plans.show', $plan) }}'" style="cursor:pointer;">
                                <td>
                                ...
                                <td><span class="badge bg-dark">{{ $plan->slug }}</span></td>
        ...
        @else
            <div class="text-center py-5">
                ...
                <p class="text-muted">Create your first plan.</p>
                <a href="{{ route('admin.subscription-plans.create') }}" class="btn btn-primary">Add Plan</a>
            </div>
        @endif
    </div>
</div>
